...
@Transactional
@BaseService
public class UpmsUserPermissionServiceImpl
		extends BaseServiceImpl<UpmsUserPermissionMapper, UpmsUserPermission, UpmsUserPermissionExample>
	...
	public int permission(JSONArray datas, int id) {
		for (int i = 0; i < datas.size(); i++) {
			...
			if (json.getBoolean("checked")) {
				...
				upmsUserPermissionExample.createCriteria().andPermissionIdEqualTo(json.getIntValue("id"))

...
CREATE TABLE `upms_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COMMENT='权限';
...
INSERT INTO `upms_permission` VALUES ('57', '1', '15', '删除日志', '3', 'upms:log:delete', '/manage/log/delete', 'zmdi zmdi-close', '1', '1489554609650', '1489554609650');
INSERT INTO `upms_permission` VALUES ('58', '1', '12', '连接池监控', '2', 'upms:druid:read', '/druid/index.html', 'zmdi zmdi-widgets', '1', '1489554840950', '1489554840950');
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COMMENT='角色权限关联表';
